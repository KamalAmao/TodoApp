...
public class CustomerRegistrationDemo extends JFrame implements ActionListener {
    ...
    public CustomerRegistrationDemo(){
        holder = new JPanel();
    ...
    public static void main(String[]args){
        CustomerRegistrationDemo customerRegistration = new CustomerRegistrationDemo();
